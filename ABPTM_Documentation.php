<?php
	/**
	 * Plugin Name: TransportTicket - Bus, Ferry, Shuttle Booking Documentation
	 * Plugin URI:
	 * Description: TransportTicket - Bus, Ferry, Shuttle Booking Documentation
	 * Version: 1.0
	 * Author: ABP-WP
	...
	if (!class_exists('ABPTM_Documentation')) {
		class ABPTM_Documentation {
			public function __construct() {
				...
				add_action('abptm_admin_enqueue', array($this, 'enqueue'), 80);
				add_action('abptm_frontend_enqueue', array($this, 'enqueue'), 80);
			...
			public function documentation() {
				?>
                <div class="abptm_area documentation">
                    <div class="abptm_container">
                        <h2 class="_abptm_text_center_color_theme">Documentation - TransportTicket - Bus, Ferry, Shuttle Booking</h2>
                        <h3 class="_abptm_text_center">=== Transport Ticket Sell with WordPress & WooCommerce ===</h3>
                        <div class="_divider_xs"></div>
                        <div class="_reflex_12_abptm_panel">
                            <div class="abptm_tabs tab_left">
                                <ul class="_abptm_bg_light tab_lists">
                                    <li data-tabs-target="#abptm_getting_start">Getting Started</li>
                                    <li data-tabs-target="#abptm_credit">Credit</li>
                                    <li data-tabs-target="#abptm_feature">Features</li>
                                    <li data-tabs-target="#abptm_installation">Installation</li>
                                    <li>
                                        <div class="_fj_between" data-collapse-target="#display_abptm_configuration" data-tabs-target="#abptm_configuration" data-open-icon="fas fa-minus" data-close-icon="fas fa-plus">Configuration <span data-icon class="fas fa-plus"></span></div>
                                        <ul class="_abptm_bg_light_1_pad_l" data-collapse="#display_abptm_configuration">
                                    ...
                                    <li>
                                        <div class="_fj_between" data-collapse-target="#display_abptm_transport" data-tabs-target="#display_abptm_transport" data-open-icon="fas fa-minus" data-close-icon="fas fa-plus">Transport Manage <span data-icon class="fas fa-plus"></span></div>
                                        <ul class="_abptm_bg_light_1_pad_l" data-collapse="#display_abptm_transport">
                                ...
                                <div class="tab_content">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_getting_start">
                                        ...
                                        <div class="_divider"></div>
                                        <ol class="_abptm_list_margin">
                                            <li><strong class="_abptm_color_theme">Version : </strong>&nbsp;&nbsp;1.0</li>
                                            <li><strong class="_abptm_color_theme">Author : </strong>&nbsp;&nbsp;<a href="https://codecanyon.net/user/abp-wp" target="_blank">ABP-WP</a></li>
                                            <li><strong class="_abptm_color_theme">Created : </strong>&nbsp;&nbsp;15 ,December 2024</li>
                                            <li><strong class="_abptm_color_theme">Last Updated : </strong>&nbsp;&nbsp;26 ,December 2024</li>
                                        </ol>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_credit">
                                        ...
                                        <div class="_divider"></div>
                                        <ol class="_abptm_list_margin">
                                            <li><strong class="_abptm_color_theme">mPDF : </strong> Thanks to mPDF team for such kind of awesome pdf tools.</li>
                                        </ol>
                                    </div>
                                    <!--    Features -->
                                    <div class="tab_item" data-tabs="#abptm_feature">
                                        ...
                                        <ol class="_abptm_list_margin">
                                            <li><strong class="_abptm_color_theme">Multi-Transport </strong></li>
                                            <li><strong class="_abptm_color_theme">Transport Search</strong></li>
                                            <li><strong class="_abptm_color_theme">Inventory Management</strong></li>
                                            <li><strong class="_abptm_color_theme">Multiple seat type</strong></li>
                                            <li><strong class="_abptm_color_theme">Time wise transport sorting</strong></li>
                                            <li><strong class="_abptm_color_theme">Traveler List Filter</strong></li>
                                            <li><strong class="_abptm_color_theme">Export Traveler List in PDF</strong></li>
                                            <li><strong class="_abptm_color_theme">Export Traveler List in CSV</strong></li>
                                            <li><strong class="_abptm_color_theme">Custom Traveler form</strong></li>
                                            <li><strong class="_abptm_color_theme">PDF Ticket</strong></li>
                                            <li><strong class="_abptm_color_theme">Send E-Mail With PDF Ticket</strong></li>
                                            <li><strong class="_abptm_color_theme">Re-Send E-Mail With PDF Ticket</strong></li>
                                            <li><strong class="_abptm_color_theme">Traveler check-in/check-out</strong></li>
                                            <li><strong class="_abptm_color_theme">Additional service</strong></li>
                                            <li><strong class="_abptm_color_theme">Buffer Time</strong></li>
                                            <li><strong class="_abptm_color_theme">Backend order</strong></li>
                                            <li><strong class="_abptm_color_theme">Boarding & dropping point</strong></li>
                                            <li><strong class="_abptm_color_theme">Transport List Shortcode</strong></li>
                                            <li><strong class="_abptm_color_theme">Route List Shortcode</strong></li>
                                            <li><strong class="_abptm_color_theme">Download Ticket Shortcode </strong></li>
                                            <li><strong class="_abptm_color_theme">Seat Type Selection</strong></li>
                                            <li><strong class="_abptm_color_theme">Flexible Date configuration</strong></li>
                                            <li><strong class="_abptm_color_theme">Tax configuration</strong></li>
                                            <li><strong class="_abptm_color_theme">Clone Transport</strong></li>
                                            <li><strong class="_abptm_color_theme">Templating</strong></li>
                                            <li><strong class="_abptm_color_theme">Translate</strong></li>
                                        </ol>
                                    </div>
                                    <!--    Installation -->
                                    <div class="tab_item" data-tabs="#abptm_installation">
                                        ...
                                        <h5 class="_abptm_color_theme">Install from WordPress dashboard</h5>
                                        <ol class="_abptm_list_margin">
                                            ...
                                            <li>Upload <code>abptm-transport-manager.zip</code> then click <code>install now</code> button.</li>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_tools">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.0.0.tools.png"><img class="_img_control_reflex_6" src="#" alt="Tools Management & Information"></div>
                                        <ol class="_abptm_list_margin">
                                            <li><strong class="_abptm_color_theme">TransportTicket - Bus, Ferry, Shuttle Booking Version :</strong>&nbsp;&nbsp;Your TransportTicket - Bus, Ferry, Shuttle Booking Plugin Version</li>
                                            <li><strong class="_abptm_color_theme">WordPress Version : </strong>&nbsp;&nbsp;WordPress Version of your site</li>
                                            <li><strong class="_abptm_color_theme">PHP Version : </strong>&nbsp;&nbsp;PHP Version of your site</li>
                                            <li><strong class="_abptm_color_theme">Woocommerce : </strong>&nbsp;&nbsp;Our plugin fully depends on WooCommerce. So it must be installed and active. If already installed, avoid it. Otherwise, click on the <strong class="_color_theme">Install &amp; Active Now</strong> button. Note: Without activating Woocommerce Our plugin all menus are not activated. so must be installed and activate Woocommerce.</li>
                                            <li><strong class="_abptm_color_theme">PDF Support Tools : </strong>&nbsp;&nbsp;ABP-WWooCommerce Transport Manager offers the option to download pdf files. The PDF feature will not work unless you install and activate the ABP Team PDF Tools addon. Downloading and installing this tool can take some time. It is possible to download manually as well. To download <a href="https://github.com/abpteam24/abpps_plugin/archive/main.zip" target="_blank">Click Me</a></li>
                                            <li><strong class="_abptm_color_theme">Search Page : </strong>&nbsp;If you want to create a transport search page, hit on <strong class="_color_theme">the Add Transport search page</strong>. Otherwise, you can manually shortcode it on any page.</li>
                                            <li><strong class="_abptm_color_theme">Search Result Page :</strong>&nbsp;&nbsp;If you want to create transport search result page hit on <strong class="_color_theme">Add Transport search result page</strong> .Otherwise, you can create it manually and use our shortcode in this page.</li>
                                            <li><strong class="_abptm_color_theme">Download Ticket Page : </strong>&nbsp;&nbsp;If you want to create Ticket Download page hit on <strong class="_color_theme">Add Download Ticket page</strong> .Otherwise, you can it manually our shortcode in any page.</li>
                                            <li><strong class="_abptm_color_theme">Number of Transport : </strong>&nbsp;&nbsp;These are describe , Total number of Transport in your site.</li>
                                            <li><strong class="_abptm_color_theme">Dummy Import</strong>&nbsp;&nbsp;If you want to create Dummy Transport hit on <strong class="_color_theme">Add New Dummy Transport</strong> .Otherwise, you can it manually .</li>
                                        </ol>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_form">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.2.form_list.png"><img class="_img_control_reflex_6" src="#" alt="Traveller Form "></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_additional">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.3.additional_list.png"><img class="_img_control_reflex_6" src="#" alt="Additional services"></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_transportation">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.4.transportation.png"><img class="_img_control_reflex_6" src="#" alt="Transportation"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"> Please input the desired slug name. Do not forget, once you modify this slug, you must refresh the permalink by going to <strong class="_abptm_color_theme">configuration-> Permalinks</strong> and clicking on the Save configuration button.</td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Dashboard Menu Icon</th>
                                                <td colspan="3">You can modify the icon in the dashboard menu from this location. The only icons that can be used on the dashboard are Dashicons. Kindly visit the <a class="_abptm" href=https://developer.wordpress.org/resource/dashicons/#calendar-alt target=_blank>Dashicons Library</a> , retrieve your icon code, and paste it in this location.</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">Please input the desired slug name for the category. Do not forget, after updating this slug, you must refresh permalinks. Simply navigate to <strong class="_abptm_color_theme">configuration-> Permalinks</strong> and click on the Save Configuration button.</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">Please input the desired slug name for the Organizer. Do not forget, after updating this slug, you must refresh permalinks. Simply navigate to <strong class="_abptm_color_theme">configuration-> Permalinks</strong> and click on the Save Configuration button.</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_transport">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.5.transport.png"><img class="_img_control_reflex_6" src="#" alt="Transport"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_layout">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.6.layout.png"><img class="_img_control_reflex_6" src="#" alt="Layout"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                                <th class="_color_theme">Date Picker Format</th>
                                                <td colspan="3"> If you wish to edit the Date Picker Format, simply choose a different format. The default date is: Like <strong class="_abptm_color_theme">Wed 24 Jul , 2024</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Enable Transport search by name ?</th>
                                                <td colspan="3">If you do not want to enable transport search by name, please switch <strong class="_abptm_color_theme"> OFF</strong> or to make it show, select <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> OFF</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Enable Return Search?</th>
                                                <td colspan="3">If you want to avoid returning search results, make sure to turn the search function <strong class="_abptm_color_theme"> OFF</strong>. Alternatively, to make it visible, choose the option <strong class="_abptm_color_theme"> ON</strong> . The default setting is <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Checkout System</th>
                                                <td colspan="3"> If you want to Only Added in cart by ajax on a single page, please select Only Add to cart by ajax. If you want to directly checkout with just one click, please select direct checkout . If you want to directly cart with just one click, please select direct cart. Default WooCommerce checkout system.</td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Search result Redirect to</th>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_ticket">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.6.1.ticket.png"><img class="_img_control_reflex_6" src="#" alt="Layout"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                                <th class="_color_theme">Generate PDF per attendee or combine</th>
                                                <td colspan="3"> You can combine numerous ticket prints into one PDF file here. To obtain this, make sure to turn <strong class="_abptm_color_theme"> ON</strong> . Otherwise, all ticket prints will be in separate PDFs. . The default setting is <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_pdf">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.7.pdf.png"><img class="_img_control_reflex_6" src="#" alt="PDF"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_traveller_pdf">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.8.pdf_list.png"><img class="_img_control_reflex_6" src="#" alt="Traveller Lists PDF"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                                <th class="_color_theme">Transport Name</th>
                                                <td colspan="3"> Please turn <strong class="_abptm_color_theme"> OFF</strong> the transport name if it is hidden in the traveler list PDF, or turn it <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Transport ID</th>
                                                <td colspan="3">If the traveler list PDF hides the transport ID, please turn it , please Switch <strong class="_abptm_color_theme"> OFF</strong> or make it visible. Turn the light <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Category</th>
                                                <td colspan="3">If the transport category is hidden in the passenger list PDF, kindly turn it <strong class="_abptm_color_theme"> OFF</strong> or make it visible. Turn <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Journey Date</th>
                                                <td colspan="3"> Please switch <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the journey date display if it is hidden in the traveler list PDF. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Total Traveller</th>
                                                <td colspan="3"> Please Turn <strong class="_abptm_color_theme"> OFF</strong> or turn<strong class="_abptm_color_theme"> ON</strong> Total Traveller if you have hidden it from the traveler list PDF. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Order ID</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the order ID to display if it is hidden from the traveler list PDF. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Traveller ID</th>
                                                <td colspan="3"> Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the traveler ID display switch if you have hidden it from the traveler list PDF. By default, <strong class="_abptm_color_theme"> OFF</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">From - To</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the From-TO option if it is hidden in the traveler list PDF. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Pickup - Drop-Off</th>
                                                <td colspan="3"> If you have hidden the Pickup-Drop-Off Point from the passenger list PDF, kindly turn it <strong class="_abptm_color_theme"> OFF</strong> or make it visible. Turn <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Order Date</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the order date display if it is hidden from the traveler list PDF. By default, <strong class="_abptm_color_theme"> OFF</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Ticket / Seat</th>
                                                <td colspan="3">Please toggle the Ticket/Seat name display <strong class="_abptm_color_theme"> ON</strong> or <strong class="_abptm_color_theme"> OFF</strong> if it is hidden in the traveler list PDF.. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Price</th>
                                                <td colspan="3">If the price is hidden in the traveler list PDF, please turn it <strong class="_abptm_color_theme"> OFF</strong> make it visible. Turn the light <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> OFF</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Traveller Info</th>
                                                <td colspan="3">Please toggle the display of passenger information <strong class="_abptm_color_theme"> OFF</strong> or <strong class="_abptm_color_theme"> ON</strong> if you have hidden it from the traveler list PDF. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Billing Information</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the bill information display if it is hidden in the traveler list PDF. By default, <strong class="_abptm_color_theme"> OFF</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Additional services</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> the additional service or make it visible if it is hidden from the traveler list PDF. Turn the light <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Check In</th>
                                                <td colspan="3">To see Checkin, turn on the Switch <strong class="_abptm_color_theme"> ON</strong> or turn <strong class="_abptm_color_theme"> OFF</strong> the Checkin from the Traveler List PDF. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Company Address</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> the company address if it is hidden in the traveler list PDF, or turn <strong class="_abptm_color_theme"> ON</strong> the company address to display. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Terms & Condition</th>
                                                <td colspan="3"> If the terms and conditions are hidden in the traveler list PDF, please turn them <strong class="_abptm_color_theme"> ON</strong> or make them hidden , Turn the light <strong class="_abptm_color_theme"> OFF</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_csv">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.9.csv.png"><img class="_img_control_reflex_6" src="#" alt="Traveller Lists CSV"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                                <th class="_color_theme">Order ID</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the order ID to display if it is hidden from the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Traveller ID</th>
                                                <td colspan="3"> Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the traveler ID display switch if you have hidden it from the traveler list CSV. By default, <strong class="_abptm_color_theme"> OFF</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Transport Name</th>
                                                <td colspan="3"> Please turn <strong class="_abptm_color_theme"> OFF</strong> the transport name if it is hidden in the traveler list CSV, or turn it <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Transport ID</th>
                                                <td colspan="3">If the traveler list CSV hides the transport ID, please turn it , please Switch <strong class="_abptm_color_theme"> OFF</strong> or make it visible. Turn the light <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Category</th>
                                                <td colspan="3">If the transport category is hidden in the passenger list CSV, kindly turn it <strong class="_abptm_color_theme"> OFF</strong> or make it visible. Turn <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Journey Date</th>
                                                <td colspan="3"> Please switch <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the journey date display if it is hidden in the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Order Date</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the order date display if it is hidden from the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">From - To</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the From-TO option if it is hidden in the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Pickup - Drop-off</th>
                                                <td colspan="3"> If you have hidden the Pickup-Drop-Off Point from the passenger list CSV, kindly turn it <strong class="_abptm_color_theme"> OFF</strong> or make it visible. Turn <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Ticket / Seat</th>
                                                <td colspan="3">Please toggle the Ticket/Seat name display <strong class="_abptm_color_theme"> ON</strong> or <strong class="_abptm_color_theme"> OFF</strong> if it is hidden in the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Price</th>
                                                <td colspan="3">If the price is hidden in the traveler list CSV, please turn it <strong class="_abptm_color_theme"> OFF</strong> make it visible. Turn the light <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Check In</th>
                                                <td colspan="3">To see Checkin, turn on the Switch <strong class="_abptm_color_theme"> ON</strong> or turn <strong class="_abptm_color_theme"> OFF</strong> the Checkin from the Traveler List CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Order Status</th>
                                                <td colspan="3"> If you hide Order Status from CSV , please Switch <strong class="_abptm_color_theme"> OFF</strong> or to display Order Status Switch <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Traveller Info</th>
                                                <td colspan="3">Please toggle the display of passenger information <strong class="_abptm_color_theme"> OFF</strong> or <strong class="_abptm_color_theme"> ON</strong> if you have hidden it from the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Billing Information</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> or turn <strong class="_abptm_color_theme"> ON</strong> the bill information display if it is hidden in the traveler list CSV. By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Additional services</th>
                                                <td colspan="3">Please turn <strong class="_abptm_color_theme"> OFF</strong> the additional service or make it visible if it is hidden from the traveler list CSV. Turn the light <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_email">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.10.email.png"><img class="_img_control_reflex_6" src="#" alt="E-Mail"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                                <th class="_color_theme">Send Mail ?</th>
                                                <td colspan="3">Should you wish to mail a traveler Turn the light <strong class="_abptm_color_theme"> ON</strong> . The mail won`t be sent if <strong class="_abptm_color_theme"> OFF</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Send pdf Ticket ?</th>
                                                <td colspan="3"> If you would like to email with PDF ticket, Turn <strong class="_abptm_color_theme"> ON</strong> otherwise the PDF won`t be sent if <strong class="_abptm_color_theme"> OFF</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_contact">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.12.contact_info.png"><img class="_img_control_reflex_6" src="#" alt="Contact Information "></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_slider">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.13.slider.png"><img class="_img_control_reflex_6" src="#" alt="Slider"></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                                <th class="_color_theme">Slider/Thumbnail ?</th>
                                                <td colspan="3">Please turn the slider switch <strong class="_abptm_color_theme"> ON</strong> or <strong class="_abptm_color_theme"> OFF</strong> if you are only showing the thumbnail . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">If you hide Indicator , please Switch <strong class="_abptm_color_theme"> OFF</strong> or to Show Indicator Switch <strong class="_abptm_color_theme"> ON</strong> . By default, <strong class="_abptm_color_theme"> ON</strong></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"> If you hide Showcase , please Switch <strong class="_abptm_color_theme"> OFF</strong> or to Show Showcase Switch <strong class="_abptm_color_theme"> ON</strong>. By default,&nbsp;<strong class="_abptm_color_theme">ON</strong></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">If you hide popup slider , please Switch <strong class="_abptm_color_theme"> OFF</strong>&nbsp;or to Show popup slider Switch&nbsp;<strong class="_abptm_color_theme"> ON</strong>. By default,&nbsp;<strong class="_abptm_color_theme">ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Popup Image Indicator</th>
                                                <td colspan="3">f you hide Popup Image Indicator , please Switch <strong class="_abptm_color_theme"> OFF</strong>&nbsp;or to Show Popup Image Indicator Switch&nbsp;<strong class="_abptm_color_theme"> ON</strong>. By default,&nbsp;<strong class="_abptm_color_theme">ON</strong></td>
                                            </tr>
                                            <tr>
                                                <th class="_color_theme">Popup Icon Indicator</th>
                                                <td colspan="3">If you hide Popup Icon Indicator , please Switch <strong class="_abptm_color_theme"> OFF</strong>&nbsp;or to Show Popup Icon Indicator Switch&nbsp;<strong class="_abptm_color_theme"> ON</strong>. By default,&nbsp;<strong class="_abptm_color_theme">ON</strong></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_css_value">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/5.14.css_value.png"><img class="_img_control_reflex_6" src="#" alt="CSS Value "></div>
                                        <table class="_abptm_fixed_text_left_mt">
                                            <tbody>
                                            <tr>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_menu">
                                        ...
                                        <ol class="_abptm_list_marin">
                                            <li><strong class="_color_theme">Transportation & all transport : </strong>view all transport</li>
                                            <li><strong class="_color_theme">add new transport : </strong>to add new transport click this</li>
                                            <li><strong class="_color_theme">Category : </strong>create transport category like AC/Non-AC</li>
                                            <li><strong class="_color_theme">Organizer : </strong>create transport Organizer like Flix</li>
                                            <li><strong class="_color_theme">Configuration : </strong>To config transport click this menu which describe before.</li>
                                            <li><strong class="_color_theme">Traveler List : </strong>You may build traveler lists in PDF/CSV format, send mail, view booking lists, and delete travelers, and many other features.</li>
                                            <li><strong class="_color_theme">Add Order : </strong>Admin create order directly</li>
                                        </ol>
                                    </div>
                                    <!--    Menu Transport-->
                                    <div class="tab_item" data-tabs="#display_abptm_transport">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/6.0.transport_list.png"><img class="_img_control_reflex_6" src="#" alt="Transportation / All Transport "></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_add_transport">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.add_transport.png"><img class="_img_control_reflex_6" src="#" alt="Add new Transport "></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_general">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.0.general.png"><img class="_img_control_reflex_6" src="#" alt="General Configuration "></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_date">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.1.date_periodic.png"><img class="_img_control_reflex_6" src="#" alt="Date Configuration"></div>
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.2.date_specific.png"><img class="_img_control_reflex_6" src="#" alt="Date Configuration"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_ticket">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.3.seat_plan.png"><img class="_img_control_reflex_6" src="#" alt="Seat Plan"></div>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">If you want to sale seat (like bus) select seat plan.</i>
                                        <ol class="_abptm_list_margin">
                                        ...
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">If you want to sale Ticket (like Ferry) select Ticket.</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.4.ticket.png"><img class="_img_control_reflex_6" src="#" alt="Date Configuration"></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_route">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.5.route.png"><img class="_img_control_reflex_6" src="#" alt="Route Configuration"></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_price">
                                        ...
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">If your ticket single type , see just like this image . please type your information</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.6.price.png"><img class="_img_control_reflex_6" src="#" alt="Price Configuration"></div>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">If your ticket Multiple type , see just like this image . please type your information</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.7.price.png"><img class="_img_control_reflex_6" src="#" alt="Price Configuration"></div>
                                        <div class="_section_alert"><strong class="_abptm">Note : </strong> Please config transport one by one. Accordingly, Ticket configuration > Route Configuration >Price Configuration</div>
                                    </div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_form">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.8.form.png"><img class="_img_control_reflex_6" src="#" alt="Traveller Form "></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_additional">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.9.additional.png"><img class="_img_control_reflex_6" src="#" alt="Additional services"></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_slider">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.10.slider.png"><img class="_img_control_reflex_6" src="#" alt="Slider"></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_post_tax">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/4.11.tax.png"><img class="_img_control_reflex_6" src="#" alt="Tax"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_category">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/6.1.category.png"><img class="_img_control_reflex_6" src="#" alt="Category"></div>
                                        <ul class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_organizer">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/6.2.organizer.png"><img class="_img_control_reflex_6" src="#" alt="Organizer"></div>
                                        <ol class="_abptm_list_margin">
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_list">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/7.1.traveller_list.png"><img class="_img_control_reflex_6" src="#" alt="abptm_list"></div>
                                        <ol class="_abptm_list_margin">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/7.2.traveller_list.png"><img class="_img_control_reflex_6" src="#" alt="abptm_list"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_create_order">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/3.1.add_order.png"><img class="_img_control_reflex_6" src="#" alt="Add Order"></div>
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/3.2.add_order.png"><img class="_img_control_reflex_6" src="#" alt="Add Order"></div>
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/3.3.add_order.png"><img class="_img_control_reflex_6" src="#" alt="Add Order"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_shortcode">
                                        ...
                                        <p class="_abptm">You can add this shortcode any page to show transport search form , you can create it automatically from <strong>Configuration > tools &amp; Info</strong> Tab.</p>
                                        <table class="_abptm">
                                            <tbody>
                                            <tr>
                                                <th>Parameter</th>
                                            ...
                                            <tr>
                                                <td>form</td>
                                                <td><strong class="_abptm_color_theme">inline</strong> or <strong class="_abptm_color_theme">column</strong> | Default: <strong class="_abptm_color_theme">inline</strong><code>[ <strong class="_abptm_color_theme">abptm-search form='column' </strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>transport</td>
                                                <td><strong class="_abptm_color_theme">on</strong> or <strong class="_abptm_color_theme">off</strong> | Default: <strong class="_abptm_color_theme">off</strong><code>[<strong class="_abptm_color_theme">abptm-search transport='on'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>return</td>
                                                <td><strong class="_abptm_color_theme">on</strong> or <strong class="_abptm_color_theme">off</strong> | Default: <strong class="_abptm_color_theme">on</strong><code>[<strong class="_abptm_color_theme">abptm-search return='off'</strong>]</code></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        <!--    Transport List shortcode -->
                                        <pre>[<strong class="_abptm_color_theme">abptm-list</strong>]</pre>
                                        <p class="_abptm">You can add this shortcode any page to show Transport LIst .</p>
                                        <table class="_abptm">
                                            <tbody>
                                            <tr>
                                                <th>Parameter</th>
                                            ...
                                            <tr>
                                                <td>style</td>
                                                <td><strong class="_abptm_color_theme">grid , grid_2 , button , anchor,list</strong> | Default: <strong class="_abptm_color_theme">grid</strong><code>[<strong class="_abptm_color_theme">abptm-list style='button'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>from</td>
                                                <td>To show specific start point , use this parameter | Default: blank<code>[<strong class="_abptm_color_theme">abptm-list from='start_place_name'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>to</td>
                                                <td>To show specific end point, use this parameter | Default: blank<code>[<strong class="_abptm_color_theme">abptm-list from='start_place_name' to='end_place_name'</strong> ]</code></td>
                                            </tr>
                                            <tr>
                                                <td>cat</td>
                                                <td>To show specific category transport, use this parameter | Default: blank<code>[<strong class="_abptm_color_theme">abptm-list cat='category_id'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>post</td>
                                                <td>To show number of transport, use this parameter | Default: <strong class="_abptm_color_theme">9</strong>(default 9 port for grid type others default 50)<code>[<strong class="_abptm_color_theme">abptm-list post='15</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>column</td>
                                                <td>To show number of transport in a line(this parameter active when style parameter any grid type), use this parameter | Default: <strong class="_abptm_color_theme">3</strong><code>[<strong class="_abptm_color_theme">abptm-list post='16' column='4'</strong>]</code></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        <!--    Route shortcode -->
                                        <pre>[<strong class="_abptm_color_theme">abptm-route</strong>]</pre>
                                        <p class="_abptm">You can add this shortcode any page to show Transport Route .</p>
                                        ...
                                        <table class="_abptm">
                                            ...
                                            <tr>
                                                <td>style</td>
                                                <td><strong class="_abptm_color_theme"> button , anchor,list</strong> | Default: <strong class="_abptm_color_theme">button</strong><code>[<strong class="_abptm_color_theme">abptm-route style='anchor'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>from</td>
                                                <td>To show specific start point , use this parameter | Default: blank<code>[<strong class="_abptm_color_theme">abptm-route from='start_place_name'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>to</td>
                                                <td>To show specific end point, use this parameter | Default: blank<code>[<strong class="_abptm_color_theme">abptm-route from='start_place_name' to='end_place_name' </strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>cat</td>
                                                <td>To show specific category transport, use this parameter | Default: blank<code>[<strong class="_abptm_color_theme">abptm-route cat='category_id'</strong>]</code></td>
                                            </tr>
                                            <tr>
                                                <td>post</td>
                                                <td>To show number of transport, use this parameter | Default: <strong class="_abptm_color_theme">50</strong><code>[<strong class="_abptm_color_theme">abptm-route post='15'</strong>]</code></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_search_page">
                                        ...
                                        <div class="_divider"></div>
                                        <code>[<strong class="_abptm_color_theme">abptm-search</strong>]</code>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block"> The output of this shortcode below</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/1.2.search_form.png"><img class="_img_control_reflex_6" src="#" alt="Search Form"></div>
                                        <code>[<strong class="_abptm_color_theme">abptm-search form='column'</strong>]</code>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block"> The output of this shortcode below</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/1.1.search_form.png"><img class="_img_control_reflex_6" src="#" alt="Search Form"></div>
                                        <code>[<strong class="_abptm_color_theme">abptm-search transport='on'</strong>]</code>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block"> The output of this shortcode below</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/1.0.search_form.png"><img class="_img_control_reflex_6" src="#" alt="Search Form"></div>
                                        <ol class="_abptm_list_margin">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/2.0.result_seat_plan.png"><img class="_img_control_reflex_6" src="#" alt="Seat plan"></div>
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/2.1.result_ticket.png"><img class="_img_control_reflex_6" src="#" alt="Ticket"></div>
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/2.2.result_list.png"><img class="_img_control_reflex_6" src="#" alt="List"></div>
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/2.3.result_seatplan.png"><img class="_img_control_reflex_6" src="#" alt="Seat plan"></div>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">If the transport is Ticket type it will look like below</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/2.4.result_ticket.png"><img class="_img_control_reflex_6" src="#" alt="Ticket"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_list_page">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/1.4.list.png"><img class="_img_control_reflex_6" src="#" alt="list Shortcode"></div>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/1.5.list.png"><img class="_img_control_reflex_6" src="#" alt="list Shortcode"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_download_ticket_page">
                                        ...
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/8.1.ticket.png"><img class="_img_control_reflex_6" src="#" alt="Ticket"></div>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">Order id or ticket number can be entered in the above input field. Here multiple inputs will be given but separated by dash sign (-).</i>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">Clicking on the view ticket button will show the result as below.</i>
                                        <div class="_mar_tb" data-image-href="<?php echo esc_url(ABPTM_DOC_URL . '/') ?>image/8.2.ticket.png"><img class="_img_control_reflex_6" src="#" alt="Ticket"></div>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_template">
                                        ...
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">The first step is to copy the abptm_templates folder from our Transport plugin and place it into your wp-content directory. Our template can now be overridden by you.</i>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_translate">
                                        ...
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">First, click Plugin>add new plugin menu . Search by typing loco translate here and install and active this.</i>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">After install loco-translate plugin, goto loco translate menu click on plugin which is sub-menu of loco translate. then click on TransportTicket - Bus, Ferry, Shuttle Booking plugin. </i>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">Now Create template or edit template then press on sync and last press on save button.</i>
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">Now you can translate very easily. All text except the plugin's documentation section can be translated. But no variables.</i>
                                    ...
                                    <div class="tab_item" data-tabs="#abptm_license">
                                        ...
                                        <ol class="_abptm_list_margin">
                                            ...
                                            <li>Search for <code>TransportTicket - Bus, Ferry, Shuttle Booking</code></li>
                                        ...
                                        <i class="_color_light_3_fs_label_mar_tb_d_block">Here's a detailed summary of the steps to retrieve your license key for the <code>TransportTicket - Bus, Ferry, Shuttle Booking</code> on Envato:</i>
                                        <ol class="_abptm_list_margin">
                                            ...
                                            <li><strong>Locate "TransportTicket - Bus, Ferry, Shuttle Booking"</strong>: In the "Downloads" section, search for the specific item you're interested in, which in this case is "TransportTicket - Bus, Ferry, Shuttle Booking" You can use the search bar or scroll through your list of downloads.</li>
                                        ...
                                        <p>By following these steps, you will have successfully retrieved your license key for the "TransportTicket - Bus, Ferry, Shuttle Booking" This key is essential for authorizing and using the Plugin on your website.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
